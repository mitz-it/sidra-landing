...
export const PlotModal: React.FC = () => {
  ...
  const getModalDimensions = () => {
    if (activeSlide === 0) return { height: "600px", width: "1000px" };
    if (activeSlide === 1) return { height: "600px", width: "700px" };
    if (activeSlide === 2) return { height: "500px", width: "700px" };
