  ...
  return (
    groupData && (
      <SurveyAnswersContainer>
                  ...
                  <ScaleContainer>
                    <ScaleBackground>
                      <Marker
                        ...
                        color="#b9b9b9"
                      >
                        <MarkerText position={item["averageForGroup"]}>
                          <svg
                            width="30"
                            height="47"
                            viewBox="0 0 30 47"
                      ...
                      <Marker
                        ...
                        color="#fc9918"
                      >
                        <MarkerText position={item["yourAnswer"]}>
                          <svg
                            width="30"
                            height="47"
                            viewBox="0 0 30 47"
        ...
        <ComparisonSection>
          <BelongSection>
            {belongData.map((item, index) => {
              ...
              return (
                <BelongCircle key={index} size={circleSize} color={item.color}>
                  <BelongCircleContent>
                    <BelongCircleLabel
                    ...
                    <BelongCirclePercent style={{ fontSize: `${fontSize}rem` }}>
                      {item.value}%
                    </BelongCirclePercent>
                    {isUserAnswer && (
                      <div
        ...
        <SurveyAnswersButton href="/about">back to the homepage</SurveyAnswersButton>
      </SurveyAnswersContainer>
    )
  );
};
