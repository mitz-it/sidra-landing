import { SurveyFormColumn, SurveyFormFlex, SurveyFormContainer, SurveyQuestion, SurveyQuestionContainer, SurveyQuestionNumber, SurveyQuestionSecondary, SurveySubQuestionContainer } from "./SurveyForm.styles";

const SurveyForm: React.FC = () => {
    return (
      <SurveyFormContainer action="">
        <section>
